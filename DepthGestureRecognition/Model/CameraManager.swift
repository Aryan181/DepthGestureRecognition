...
class CameraManager: ObservableObject, CaptureDataReceiver, GestureRecognitionDelegate {
    func didRecognizeGesture(_ gesture: String) {
        DispatchQueue.main.async {
            print("Recognized gesture: \(gesture)")
            self.lastRecognizedGesture = gesture
        }
    }
    ...
    @Published var lastRecognizedGesture: String = "Unknown"
